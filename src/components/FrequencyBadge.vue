...
import { FREQUENCY_LABELS, type TaskFrequency } from '@/entities'

defineProps<{ frequency: TaskFrequency }>()
</script>

<template>
  <span class="badge" :class="frequency">{{ FREQUENCY_LABELS[frequency] }}</span>
</template>
